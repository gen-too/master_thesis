package dbs.bigdata.flink.pprl.utils.bloomfilter;
...
public class BloomFilter {
	 ...
	 * @return
	 */
	public static BloomFilter from(String bits){		
		BitSet bitset = new BitSet(bits.length()-1);
		...
		return new BloomFilter(bits.length()-1, 0, bitset);
	}
